      ...
      <div className="flex justify-between items-center mb-6">
        <div className="flex space-x-4">
          ...
          <button
            ...
            className="flex items-center space-x-2 p-2 bg-blue-600 rounded-lg shadow-sm hover:bg-blue-700 transition duration-150 cursor-pointer text-white"
          >
            <span className="font-semibold">Create Order</span>
            <div className="bg-white/20 rounded p-1">
              <img src="/images/icon/shipments-icon.png" alt="create_icon" className="w-4 h-4 invert" />
            </div>
          </button>
          <button
            onClick={() => {
